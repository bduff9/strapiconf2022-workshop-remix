...
import type { StrapiResponse, Tip } from "~/types/strapi";
...
export const loader: LoaderFunction = async ({ params }) => {
	...
	const res = await fetch(`${process.env.STRAPI_URL_BASE}/api/tips?populate=*&filters[Slug]=${params.tipId}`, {
		method: 'GET',
		headers: {
	...
	const data: StrapiResponse<Tip> = await res.json();
